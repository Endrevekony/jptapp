...
void main() {
  ...
  setUp(() {
    mockSharedPreferences = MockSharedPreferences();
    dataSource =
        ListItemsLocalDataSourceImpl(sharedPreferences: mockSharedPreferences);
  });
  ...
  group('getLastItems', () {
    test(
        'should return items from shared preferences when there are in the cache',
        () async {
      when(mockSharedPreferences.getString(any))
          .thenReturn(fixture('items.json'));
